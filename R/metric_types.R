...
metric_types <- function(report_mdufa_period = "MDUFA IV") {
  if (report_mdufa_period == "MDUFA IV") {
    ...
    tibble::tribble(
      ...
      "Number with a decision (MDUFA or Non- MDUFA)", "integer",
      "% of FY closed", "percent",
      # Additional metrics with case/character variations
      "Closed Before RTA Action or TS", "integer",
      "Performance Metrics", "text",
      "Current SI Performance Percent within 90 FDA days", "percent",
      "Eligible for MDUFA IV Decisions", "integer",
      "MDUFA IV Decisions within 150 FDA Days", "integer",
      "CLIA Waiver Applications pending MDUFA IV Decision", "integer",
      "CLIA Waiver Applications pending MDUFA IV Decision over 150 FDA days",
      "integer",
      "Current Performance Percent within 150 FDA Days", "percent",
      "MDUFA IV Decisions within 320 FDA Days", "integer",
      "CLIA Waiver Applications pending MDUFA IV Decision over 320 FDA days",
      "integer",
      ...
      "80th Percentile Total days to MDUFA IV decision", "integer",
      "Maximum Total days to MDUFA IV decision", "integer",
      "Eligible for MDUFA IV Decision", "integer",
      "MDUFA IV Decisions within 180 FDA Days", "integer",
      "CLIA Waiver Applications pending MDUFA IV Decision over 180 FDA days",
      "integer",
      "Current Performance Percent within 180 FDA Days*", "percent",
      "MDUFA IV Decisions with in 320 FDA Days", "integer",
      "Number with MDUFA IV decision", "integer",
      # En-dash variants (U+2013)
    ...
    tibble::tribble(
      ...
      # Additional metrics with case/character/footnote variations
      paste0(
        "Number Without a First RTA Review and <= 15 Days Since Date Received ",
        "(First RTA Action Pending)"
      ), "integer",
      "Closed Before First RTA or TS Action \u00B9", "integer",
      "Number Accepted or Passed TS on First Cycle \u00B2", "integer",
      "Number Without a RTA or TS Review and > 15 Days Since Date Received \u00B3", # nolint
      "integer",
      "Number Without a RTA or TS Review and <= 15 Days Since Date Received \u00B9", # nolint
      "integer",
      "Number Not Accepted or Failed TS on First Cycle \u00B2", "integer",
      "Rate of Submissions Not Accepted for Review or Failed TS on First Cycle \u00B2", # nolint
      "percent",
      "Performance Metrics", "text",
      paste0(
        "Number With MDUFA Decision (CDRH+CBER) Within a 99% Closed Cohort ",
        "With Provisions 3"
      ), "integer",
      "Decision on the remaining cohort.", "text",
      "Average Number of Days to Accept / Refuse to Accept on First RTA Cycle",
      "double",
      "Subs in the MDUFA Cohort if the MDUFA Cohort is 3585 or more.", "text",
      "Subs in the MDUFA Cohort if the MDUFA Cohort is 4060 or more.", "text",
      "Current SI Performance Percent within 90 FDA days", "percent",
      "Eligible for MDUFA V Decisions", "integer",
      "MDUFA V Decisions within 150 FDA Days", "integer",
      "CLIA Waiver Applications pending MDUFA V Decision", "integer",
      "CLIA Waiver Applications pending MDUFA V Decision over 150 FDA days",
      "integer",
      "Current Performance Percent within 150 FDA Days", "percent",
      "MDUFA V Decisions within 320 FDA Days", "integer",
      "CLIA Waiver Applications pending MDUFA V Decision over 320 FDA days",
      "integer",
      "Current Performance Percent within 320 FDA Days", "percent",
      "Number with MDUFA decision", "integer",
      "Average FDA days to MDUFA V decision", "double",
      ...
      "80th Percentile Total days to MDUFA V decision", "integer",
      "Maximum Total days to MDUFA V decision", "integer",
      "Eligible for MDUFA V Decision", "integer",
      "MDUFA V Decisions within 180 FDA Days", "integer",
      "CLIA Waiver Applications pending MDUFA V Decision over 180 FDA days",
      "integer",
      "Current Performance Percent within 180 FDA Days*", "percent",
      "MDUFA V Decisions with in 320 FDA Days", "integer",
      "Number with MDUFA V decision", "integer",
      # En-dash variants (U+2013)
      "Original PMAs (Panel) \u2013 Priority", "integer",
      "Original PMAs (No Panel) \u2013 Priority", "integer",
