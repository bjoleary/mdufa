# Do not hand edit this file. Edit data-raw/mdufa5.R instead.
#' MDUFA V
#'
#' FDA's Quarterly Medical Device User Performance Metrics in a tidy data
#' format.
#'
#' @format A tibble with 14005 rows and 14 fields:
#'
#' \describe{
#' \item{report_description}{chr "February 27, 2025 MDUFA V Performance
#' Report"…}
#' \item{report_link}{chr "https://www.fda.gov/media/185639/download", "…}
#' \item{report_date}{date 2025-02-27, 2025-02-27, 2025-02-27, 2025-02-2…}
#' \item{report_mdufa_period}{chr "MDUFA V", "MDUFA V", "MDUFA V", "MDUFA V",
#' "M…}
#' \item{source}{chr "Table 1.1 CDRH - PMA Original and Panel-Track…}
#' \item{page}{int 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30, 30…}
...
#' \item{value}{chr "73", "69", "22", NA, NA, "0", "0", "0", NA, N…}
#' }
#'
#' @source
