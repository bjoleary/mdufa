# Do not hand edit this file. Edit data-raw/mdufa2.R instead.
#' MDUFA II
#'
#' FDA's Quarterly Medical Device User Performance Metrics in a tidy data
#' format.
#'
#' @format A tibble with 335 rows and 14 fields:
#'
#' \describe{
...
#' \item{performance_metric}{chr "Workload (Filed to Date)", "Workload (Filed
#' t…}
#' \item{fy}{chr "2008", "2009", "2010", "2011", "2012", "2008"…}
#' \item{value}{chr "33", "39", "53", "44", "29", "33", "39", "53"…}
#' }
#'
#' @source
